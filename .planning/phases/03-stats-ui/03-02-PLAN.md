...
<task type="auto">
  ...
  <action>
    ...
    6. Render:
       ...
       - LeaderboardFilters with disabledFilters={['competition']} (competition pre-selected, disabled)
...
<task type="auto">
  ...
  <action>
    ...
    5. Render:
       ...
       - LeaderboardFilters with disabledFilters={['club']} (club pre-selected, disabled)
       - LeaderboardTable with entries from data
